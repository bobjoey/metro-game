...
//	public int nextSong = 3; //SongsList array index
	public static songCard[] songsList = {new songCard("ZenZenZense"), new songCard("Lagtrain"), new songCard("OCOLIMBO"), new songCard("cOin")};
	...
	{
		songsList = new songCard[]{new songCard("ZenZenZense"), new songCard("Lagtrain"), new songCard("OCOLIMBO"), new songCard("cOin")};
